...
def generate_launch_description():
    ...
    # Setup project paths
    pkg_project_description = get_package_share_directory('my_robot')
    pkg_ros_gz_sim = get_package_share_directory('ros_gz_sim')

    # # Load the URDF file from "description" package
    # urdf_file  =  os.path.join(pkg_project_description, 'urdf', '.urdf')
    # with open(urdf_file, 'r') as infp:
    #     robot_desc = infp.read()

    urdf_path  =  os.path.join(pkg_project_description, 'urdf', 'my_robot.urdf.xacro')
